...
<div id="a21_form_oformit_zakaz" class="white-popup-block mfp-hide">
    ...
    <form>
    <table>
        <tr><td>Ф.И.О<span class="req">*</span></td><td><input type="text" name="name" class="name" value="<?php if($cur_user->user_firstname) echo $cur_user->user_firstname;?>" ></td></tr>
        <tr><td>Телефон<span class="req">*</span></td><td><input type="text" name="phone" class="phone" value="<?php echo $phone;?>"></td></tr>
        <tr><td>E-mail<span class="req">*</span></td><td><input type="text" name="mail" class="mail" value="<?php if($cur_user->user_email) echo $cur_user->user_email;?>"></td></tr>
        <tr><td>Адрес доставки:<span class="req">*</span></td><td><input type="text" name="address" class="address" ></td></tr>
